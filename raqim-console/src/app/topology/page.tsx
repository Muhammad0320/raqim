  ...
  return (
    <MainLayout title="Swarm Topology">
      <div className="flex h-full w-full overflow-hidden">
        ...
        <section className="flex-1 bg-surface-container-lowest relative overflow-hidden flex flex-col" style={{ backgroundImage: 'radial-gradient(rgba(255,255,255,0.03) 1px, transparent 1px)', backgroundSize: '32px 32px' }}>
          {/* Canvas Header Toolbar */}
          <div className="h-14 border-b border-outline-variant/15 bg-surface-container/80 backdrop-blur-md flex items-center justify-between px-6 z-10 shrink-0">
              ...
              <div className="absolute top-[35%] left-[25%] glass-panel border border-primary-container/30 rounded p-4 w-64 shadow-[0_20px_40px_rgba(0,0,0,0.5)] agent-scan-line cursor-move hover:border-primary-container transition-colors">
                <div className="flex justify-between items-start mb-3">
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-primary-container text-[20px]">device_hub</span>
        ...
        <aside className="w-80 bg-surface border-l border-outline-variant/15 flex flex-col h-full z-20 shadow-[-10px_0_30px_rgba(0,0,0,0.2)] shrink-0">
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto p-2 space-y-1">
            ...
            <div className="group bg-surface-container hover:bg-surface-container-high border border-transparent hover:border-outline-variant/20 rounded p-2.5 cursor-pointer transition-all">
              <div className="flex justify-between items-start mb-1.5">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-primary-container text-[14px]">query_stats</span>
