        ...
        <div className="px-6 py-6 mb-2 shrink-0 bg-zinc-900/20 border-b border-zinc-900">
          <div className="flex items-center gap-4 mb-3">
            <div className="w-12 h-12 bg-zinc-900 border border-zinc-700 flex items-center justify-center shrink-0">
              {/* Generative Identicon (SVG Pattern) */}
              <svg width="40" height="40" viewBox="0 0 5 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0" y="0" width="1" height="1" fill="#00f3ff" opacity="0.8" />
                <rect x="4" y="0" width="1" height="1" fill="#00f3ff" opacity="0.8" />
                <rect x="1" y="1" width="1" height="1" fill="#00f3ff" opacity="0.4" />
                <rect x="3" y="1" width="1" height="1" fill="#00f3ff" opacity="0.4" />
                <rect x="2" y="0" width="1" height="1" fill="#00f3ff" opacity="1" />
                <rect x="2" y="2" width="1" height="1" fill="#00f3ff" opacity="0.6" />
                <rect x="2" y="4" width="1" height="1" fill="#00f3ff" opacity="1" />
                <rect x="0" y="4" width="1" height="1" fill="#00f3ff" opacity="0.8" />
                <rect x="4" y="4" width="1" height="1" fill="#00f3ff" opacity="0.8" />
                <rect x="1" y="3" width="1" height="1" fill="#00f3ff" opacity="0.4" />
                <rect x="3" y="3" width="1" height="1" fill="#00f3ff" opacity="0.4" />
                <rect x="0" y="2" width="1" height="1" fill="#00f3ff" opacity="0.2" />
                <rect x="4" y="2" width="1" height="1" fill="#00f3ff" opacity="0.2" />
              </svg>
            </div>
            <div className="flex flex-col">
              <h2 className="font-mono text-xs font-bold text-white uppercase tracking-widest leading-tight">JPM_CHASE_PROD</h2>
              <p className="font-mono text-[9px] text-[#ffb300] uppercase tracking-[0.2em] mt-1">CLEARANCE: LEVEL_9</p>
            </div>
          </div>
